---
title: "S17: Analysis with combination of competitive and self-contained null models"
output:
...
|----------|--------------------------|--------|---------------------------------------|-------------------------|-----------------------|------------------------|-----------------------------------------|
| S17     | Desikan (34)             | 0.4    | 1000 simulated maps (Moran's I=0.03) | 500 simulated gene sets | Pearson Correlation   | Self-contained and competitive combined | Mean, Meanabs, Meansqr, Maxmean, Median, Sig Number, KS, Weighted KS |

*Note: For comparisons, results of the Main analysis are also included.*
...
null_type_label=c('Competitive null model',
                   ...
                   'Self-contained and competitive combined')
stat_level=c('mean',
            'meanabs',
            'meansqr',
            'maxmean',
...
```{r,warning=F,fig.height=16, fig.width=18}
...
p5=grid.arrange(grobs=coexp_res.plot.list[[null_type_level[3]]],
                ncol=2,
                top = textGrob(sprintf("C. %s",null_type_label[3]),gp=gpar(fontsize=16,font=1),x = -0.01, hjust = 0),
                left =textGrob("Psig-G",gp=gpar(fontsize=12,font=2),rot=90),
                bottom=textGrob("Co-expression",gp=gpar(fontsize=12,font=2)))
```
...
```
```{r fig.height=24, fig.width=12, echo=FALSE}
grid.arrange(p3,p4,p5,ncol=1)
```
...
p4=grid.arrange(grobs=brain_res.plot.list[[null_type_level[2]]],
                ...
                left =textGrob("Psig-B",gp=gpar(fontsize=12,font=2),rot=90),
                bottom=textGrob("Bimodality",gp=gpar(fontsize=12,font=2)))
p5=grid.arrange(grobs=brain_res.plot.list[[null_type_level[3]]],
                ncol=2,
                top = textGrob(sprintf("C. %s",null_type_label[3]),gp=gpar(fontsize=16,font=1),x = -0.01, hjust = 0),
                left =textGrob("Psig-B",gp=gpar(fontsize=12,font=2),rot=90),
                bottom=textGrob("Bimodality",gp=gpar(fontsize=12,font=2)))
...
df3=brain_res.report.list[[null_type_level[3]]]
kable(df1,caption = sprintf("A. %s",null_type_label[1]))%>%
  kable_styling(full_width = FALSE, position = "float_left")
kable(df2,caption = sprintf("B. %s",null_type_label[2]))%>%
  kable_styling(full_width = FALSE, position = "left")
