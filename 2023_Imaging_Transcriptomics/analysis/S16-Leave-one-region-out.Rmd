---
title: "S16: Analysis using leave-one-region-out correlation"
output:
...
|----------|--------------------------|--------|---------------------------------------|-------------------------|-----------------------|------------------------|-----------------------------------------|
| S16     | Shaefer200 (100)             | 0.4    | 1000 simulated maps (Moran's I=0.03) | 500 simulated gene sets | Leave one-region-out correlation   | Competitive / Self-contained | Mean, Meanabs, Meansqr, Maxmean, Median, Sig Number, KS, Weighted KS |
