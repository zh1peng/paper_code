# make plots for overarching effect sizes
...
# make plots
all_post=readRDS("Posterior_L_sv.rds")
p1=plot_post_para(all_post,orig_label,full_label, para2plot='mu',xlab2show='M', ylab2show='Regions')
p2=map_post_mode(all_post,orig_label,ggseg_label,'mu','aseg','left','Subcortical volume (Left)')
ggsave('Posterior_L_sv_ridge.png',p1,width = 6,height = 4)
ggsave('Posterior_L_sv_brain.png',p2,width = 4,height = 4)
rm(all_post,p1,p2)
gc()

all_post=readRDS("Posterior_R_sv.rds")
p1=plot_post_para(all_post,orig_label,full_label, para2plot='mu',xlab2show='M', ylab2show='Regions')
p2=map_post_mode(all_post,orig_label,ggseg_label, 'mu', 'aseg','right','Subcortical volume (Right)')
ggsave('Posterior_R_sv_ridge.png',p1,width = 6,height = 4)
ggsave('Posterior_R_sv_brain.png',p2,width = 4,height = 4)
rm(all_post,p1,p2)
gc()
...
ggsave('Posterior_L_ct_ridge.png',p1,width = 6,height = 8)
ggsave('Posterior_L_ct_brain.png',p2,width = 4,height = 4)
rm(all_post,p1,p2)
gc()
...
ggsave('Posterior_R_ct_ridge.png',p1,width = 6,height = 8)
ggsave('Posterior_R_ct_brain.png',p2,width = 4,height = 4)
rm(all_post,p1,p2)
gc()


# SA
all_post=readRDS("Posterior_L_sa.rds")
p1=plot_post_para(all_post,orig_label,full_label, para2plot='mu',xlab2show='M', ylab2show='Regions')
p2=map_post_mode(all_post,orig_label,ggseg_label,'mu','dk','left','Surface area (Left)',c(-0.3,0.3))
ggsave('Posterior_L_sa_ridge.png',p1,width = 6,height = 8)
ggsave('Posterior_L_sa_brain.png',p2,width = 4,height = 4)
rm(all_post,p1,p2)

all_post=readRDS("Posterior_R_sa.rds")
p1=plot_post_para(all_post,orig_label,full_label, para2plot='mu',xlab2show='M', ylab2show='Regions')
p2=map_post_mode(all_post,orig_label,ggseg_label,'mu','dk','right','Surface area (Right)',c(-0.3,0.3))
ggsave('Posterior_R_sa_ridge.png',p1,width = 6,height = 8)
ggsave('Posterior_R_sa_brain.png',p2,width = 4,height = 4)
rm(all_post,p1,p2)
gc()
