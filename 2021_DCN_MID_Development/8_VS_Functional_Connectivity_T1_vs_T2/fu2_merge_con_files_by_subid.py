...
import os
subdf=pd.read_csv('fu2_subid.csv')
...
for folder_i in folder_name:
	...
	concat_img.to_filename('/gpfs1/home/z/c/zcao4/IMAGEN_MID_analysis/PPI_LME_new_subid_unbalanced/merge_con_files/FU2_all_con1_%s.nii' %folder_i)
