function bsl_calculate_network_vacc_function(subi)
% load subid
...
save(['/gpfs1/home/z/c/zcao4/IMAGEN_MID_analysis/fc_analysis/bsl_fc_code/summary_files/network_sum_',subid{subi},'.mat'],'net_sum','node_sum')
catch
save(['/gpfs1/home/z/c/zcao4/IMAGEN_MID_analysis/fc_analysis/bsl_fc_code/summary_files/network_sum_',subid{subi},'_error.mat'])
end
end
end
