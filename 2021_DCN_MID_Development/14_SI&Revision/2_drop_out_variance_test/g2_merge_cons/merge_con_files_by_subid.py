...
import os
subdf=pd.read_csv('g2_subid_n1054.csv')
...
concat_img.to_filename('/gpfs1/home/z/c/zcao4/IMAGEN_MID_analysis/test_var/BSL_g2_activiation.nii')
...
#	subdf.to_csv('BSL_test_file_exist_%s.csv' %folder_i)
	...
	concat_img=nib.funcs.concat_images(all_files)
	concat_img.to_filename('/gpfs1/home/z/c/zcao4/IMAGEN_MID_analysis/test_var/BSL_g2_%s.nii' %folder_i)
