...
result_df=cbind(result_df,net_info)
rownames(result_df)=c('wu_net_aLp','wu_net_adeg','wu_net_aCp','mgt_vsr_node_MTG')
write.csv(result_df,'/Users/zhipeng/Google Drive/post-doc/MID_network_FU2/process_code/intersect_cov/AUDIT analysis new subid/revision_analysis/alc_l3h8_results.csv')
