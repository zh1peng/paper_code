ptm=proc.time()
source('/gpfs1/home/z/c/zcao4/IMAGEN_MID_analysis/activiation_LME_new_subid_unbalanced/vx_LME_functions_time_sex.R')
...
# 3 true model
result_path='/gpfs1/home/z/c/zcao4/IMAGEN_MID_analysis/activiation_LME_new_subid_unbalanced'
