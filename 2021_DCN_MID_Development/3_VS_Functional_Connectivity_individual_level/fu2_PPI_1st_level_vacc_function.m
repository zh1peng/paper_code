function []=fu2_PPI_1st_level_vacc_function(subidx)
%% 0. Setup variables
addpath(genpath('/gpfs1/home/z/c/zcao4/matlab_tools/spm12'));
addpath('/gpfs1/home/z/c/zcao4/IMAGEN_MID_analysis/PPI_1st_level/FU2_code')
spm_jobman('initcfg');
spm('defaults','fmri');
% warning('off','MATLAB:MKDIR:DirectoryExists');
subidfile='/gpfs1/home/z/c/zcao4/IMAGEN_MID_analysis/PPI_1st_level/FU2_code/subid_fu2_good_fc_file_1365.mat';
load(subidfile)
data_path= '/gpfs2/scratch/zcao4/IMAGEN_MID_data/FU2_1st_level';
EPI_data_path='/gpfs2/scratch/zcao4/IMAGEN_MID_data/MID_FU2_EPI'
...
result_path='/gpfs2/scratch/zcao4/IMAGEN_MID_data/FU2_PPI_1st_level';
...
ppiflag = 'psychophysiologic interaction';
    for Vi=1:length(My_VOI)
        ...
        my_spm_regions(SPM, VOI_xyz {Vi}, My_VOI{Vi}, 2, 3); %F is 1+1=2
