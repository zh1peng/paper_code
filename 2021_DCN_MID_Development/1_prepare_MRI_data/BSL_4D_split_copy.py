...
output = r'/gpfs2/scratch/zcao4/IMAGEN_MID_data/MID_BL_EPI'
search_test = r'/gpfs2/scratch/acjulian/IMAGEN_files_still_need_BIDSifying/Task_BSL_Funcs/*/EPI_short_MID/*sw*.nii.gz'
