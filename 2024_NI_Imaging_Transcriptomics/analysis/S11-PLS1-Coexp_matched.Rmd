---
title: "S11: Analysis using the partial least square (PLS) regression coefficients and coexp-matched competitive null model"
output:
...
|----------|--------------------------|--------|---------------------------------------|-------------------------|-----------------------|------------------------|-----------------------------------------|
| S11     | Desikan (34)             | 0.4    | 1000 simulated maps (Moran's I=0.03) | 500 simulated gene sets | PLS1 Coefficients   | Competitive / Coexp-matched Competitive | Mean, Meanabs, Meansqr, Maxmean, Median, KS, Weighted KS |
