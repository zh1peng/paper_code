...
res_path='/media/NAS/Projects/ORA/sim_res_Aurina_annotation_BP'

anno2test <- "GO_BP"
protein_genes <- readRDS(file.path(data_path, "bp_genes.rds")) # use use annotation genes from MF
...
ahba_genes <- readRDS(file.path(data_path, "AHBA_genes_Aurina2019.rds"))
