...
subid=textread('fu2_log.txt','%s');
data_path='/gpfs2/scratch/acjulian/IMAGEN_files_still_need_BIDSifying/Task_FU2_Funcs/';
output_path='/gpfs2/scratch/zcao4/IMAGEN_MID_data/MID_FU2_EPI';
failed_subid={}
for indx=1:length(subid)
    subfolder=fullfile(data_path,subid{indx},'EPI_mid');
